...
namespace MaisApoio.MaisApoio.Controllers.Controllers
{
    public class VoluntarioController : ControllerBase
    {
        ...
        public VoluntarioController(VoluntarioAplicacao voluntarioAplicacao, EnderecoDoadorAplicacao enderecoAplicacao)
        {
        ...
        public async Task<IActionResult> CriarAsync([FromBody] VoluntarioCriacao voluntarioCriacao)
        {
            try
            {
                var doadorID = await _voluntarioAplicacao.CriarAsync(new Voluntario(voluntarioCriacao.Nome, voluntarioCriacao.Cpf, voluntarioCriacao.Telefone, voluntarioCriacao.AreaAtuacao, voluntarioCriacao.Email, voluntarioCriacao.Senha, voluntarioCriacao.DataNascimento);
