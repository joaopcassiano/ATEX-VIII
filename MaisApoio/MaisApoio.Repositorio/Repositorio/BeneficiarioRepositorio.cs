...
public class BeneficiarioRepositorio
{
    ...
    public async Task<Beneficiario> ObterPorEmailAsync(string email)
    {
        ...
        var beneficiarios = await conexao.QueryFirstOrDefaultAsync<Beneficiario>(sql, new { email = email }).ToList();
    ...
    public async Task<Beneficiario> ObterPorCPFAsync(string cpf)
    {
        ...
        var conexao = _banco.ConectarSqlServer();
        conexao.Open();
        var beneficiarios = await conexao.QueryFirstOrDefaultAsync<Beneficiario>(sql, new { cpf = cpf });
        conexao.Close();
        return beneficiarios;
    }
    ...
    public async Task<Beneficiario> ObterPorNomeAsync(string nome)
    {
        ...
        var conexao = _banco.ConectarSqlServer();
        conexao.Open();
        var beneficiarios = await conexao.QueryFirstOrDefaultAsync<Beneficiario>(sql, new { nome = nome }).ToList();
        conexao.Close();
        return beneficiarios;
    }
    public async Task<List<Beneficiario>> ObterPorNomeNecessidadeAsync(string nome, string necessidade)
    {
        ...
        var conexao = _banco.ConectarSqlServer();
        conexao.Open();
        var beneficiarios = await conexao.QueryAsync<Beneficiario>(sql, new { nome = nome, necessidade = necessidade }).ToList();
        conexao.Close();
        return beneficiarios;
    }
    ...
    public async Task<List<Beneficiario>> ObterPorNomeSituacaoEconomicaAsync(string nome, string situacaoEconomica)
    {
        ...
        var conexao = _banco.ConectarSqlServer();
        conexao.Open();
        var beneficiarios = await conexao.QueryAsync<Beneficiario>(sql, new { nome = nome, situacaoEconomica = situacaoEconomica }).ToList();
        conexao.Close();
        return beneficiarios;
    }
    public async Task<List<Beneficiario>> ObterPorNecessidadeSituacaoEconomicaAsync(string necessidade, string situacaoEconomica)
    {
        ...
        var conexao = _banco.ConectarSqlServer();
        conexao.Open();
        var beneficiarios = await conexao.QueryAsync<Beneficiario>(sql, new { necessidade = necessidade, situacaoEconomica = situacaoEconomica }).ToList();
        conexao.Close();
        return beneficiarios;
    }
    public async Task<List<Beneficiario>> ObterPorNomeNecessidadeSituacaoEconomicaAsync(string nome, string necessidade, string situacaoEconomica)  
    {
        ...
        var conexao = _banco.ConectarSqlServer();
        conexao.Open();
        var beneficiarios = await conexao.QueryAsync<Beneficiario>(sql, new { nome = nome, necessidade = necessidade, situacaoEconomica = situacaoEconomica }).ToList();
        conexao.Close();
        return beneficiarios;
    }
    public async Task<List<Beneficiario>> ObterPorDataDeNascimentoAsync(datetime dataNascimento)
    {
        ...
        var conexao = _banco.ConectarSqlServer();
        conexao.Open();
        var beneficiarios = await conexao.QueryAsync<Beneficiario>(sql, new { dataNascimento = dataNascimento }).ToList();
        conexao.Close();
        return beneficiarios;
    }
    public async Task<List<Beneficiario>> ObterPorDataDeNascimentoNecessidadeAsync(datetime dataNascimento, string necessidade)
    {
        ...
        var conexao = _banco.ConectarSqlServer();
        conexao.Open();
        var beneficiarios = await conexao.QueryAsync<Beneficiario>(sql, new { dataNascimento = dataNascimento, necessidade = necessidade }).ToList();
        conexao.Close();
        return beneficiarios;
    ...
    public async Task<List<Beneficiario>> ObterPorDataDeNascimentoSituacaoEconomicaAsync(datetime dataNascimento, string situacaoEconomica)
    {
        ...
        var conexao = _banco.ConectarSqlServer();
        conexao.Open();
        var beneficiarios = await conexao.QueryAsync<Beneficiario>(sql, new { dataNascimento = dataNascimento, situacaoEconomica = situacaoEconomica }).ToList();
        conexao.Close();
        return beneficiarios;
    }
    public async Task<List<Beneficiario>> ObterPorDataDeNascimentoNomeAsync(datetime dataNascimento, string nome)
    {
        ...
        var conexao = _banco.ConectarSqlServer();
        conexao.Open();
        var beneficiarios = await conexao.QueryAsync<Beneficiario>(sql, new { dataNascimento = dataNascimento, nome = nome }).ToList();
        conexao.Close();
        return beneficiarios;
    }
